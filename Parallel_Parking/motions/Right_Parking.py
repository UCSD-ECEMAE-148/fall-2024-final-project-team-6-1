...
def execute_right_parking(vesc, parking_file="/home/jetson/projects/final_project/recordings/Right_Parking.csv"):
    ...
    for i in range(len(motion_data)-1):
        ...
        logger.debug(f"Right Parking -> Steering: {steering:.2f}, RPM: {rpm}")
