...
def execute_right_exit(vesc, parking_file="/home/jetson/projects/final_project/recordings/Right_Exit.csv"):
    ...
    for i in range(len(motion_data)-1):
        ...
        logger.debug(f"Right Exit -> Steering: {steering:.2f}, RPM: {rpm}")
